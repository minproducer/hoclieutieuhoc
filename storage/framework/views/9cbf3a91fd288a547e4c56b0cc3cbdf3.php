...
<?php $__env->startSection('title', 'Tải xuống — ' . $document->title . ' - ' . \App\Models\Setting::get('site_name', 'HocLieuTieuHoc')); ?>
<?php $__env->startSection('description', 'Tải miễn phí: ' . $document->title); ?>
...
<div class="max-w-5xl mx-auto px-4 sm:px-6 py-10">
    ...
    <nav class="flex items-center gap-2 text-sm text-gray-400 mb-8">
        <a href="<?php echo e(route('home')); ?>" class="hover:text-primary-600 transition-colors">Trang chủ</a>
        ...
        <a href="<?php echo e(route('category.show', $document->category->slug)); ?>" class="hover:text-primary-600 transition-colors"><?php echo e($document->category->name); ?></a>
        <i class="fa-solid fa-chevron-right text-[10px]"></i>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <a href="<?php echo e(route('document.show', $document->slug)); ?>" class="hover:text-primary-600 transition-colors truncate max-w-[200px]"><?php echo e($document->title); ?></a>
        <i class="fa-solid fa-chevron-right text-[10px]"></i>
        ...
        <div class="lg:col-span-2 space-y-5">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 px-5 py-4 flex items-center gap-4">
                <div class="w-11 h-11 rounded-xl bg-primary-50 flex items-center justify-center flex-shrink-0">
                    <i class="fa-solid <?php echo e($fileTypeIcons[$document->file_type] ?? 'fa-file'); ?> text-xl text-primary-500"></i>
                </div>
                <div class="flex-1 min-w-0">
                    <p class="font-bold text-gray-900 truncate leading-tight"><?php echo e($document->title); ?></p>
                    <p class="text-xs text-gray-400 mt-0.5">
                        <span class="<?php echo e($fileTypeColors[$document->file_type] ?? ''); ?> text-[10px] font-bold px-1.5 py-0.5 rounded mr-1"><?php echo e(strtoupper($document->file_type)); ?></span>
                        <?php echo e($document->category?->name); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($document->grade_level): ?> · Lớp <?php echo e($document->grade_level); ?><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden relative">
                ...
                <div id="ready-state" class="hidden px-6 py-10 flex flex-col items-center text-center">
                    ...
                    <a href="<?php echo e(route('document.download', $document->slug)); ?>"
                       id="dl-btn"
                       ...
                       style="background:linear-gradient(135deg,#d97706,#92400e);">
                        ...
                        <span class="relative z-10 text-left">
                            ...
                            <span style="display:block;font-size:.7rem;font-weight:400;opacity:.75;margin-top:2px;"><?php echo e($document->file_size_formatted); ?> · <?php echo e(strtoupper($document->file_type)); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </span>
                    </a>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($relatedDocs->isNotEmpty()): ?>
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $relatedDocs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
                ...
                <dl class="space-y-0 text-sm divide-y divide-gray-50">
                    <div class="flex justify-between py-2.5">
                        ...
                        <dd class="font-semibold text-gray-700 uppercase"><?php echo e($document->file_type); ?></dd>
                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($document->file_size_kb): ?>
                    <div class="flex justify-between py-2.5">
                        <dt class="text-gray-400">Kích thước</dt>
                        <dd class="font-semibold text-gray-700"><?php echo e($document->file_size_formatted); ?></dd>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="flex justify-between py-2.5">
                        ...
                        <dd class="font-semibold text-gray-700"><?php echo e($document->page_count); ?> trang</dd>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <div class="flex justify-between py-2.5">
                        <dt class="text-gray-400">Lượt tải</dt>
                        <dd class="font-semibold text-gray-700"><?php echo e(number_format($document->download_count)); ?></dd>
                    </div>
                    <div class="flex justify-between py-2.5">
                        <dt class="text-gray-400">Lượt xem</dt>
                        <dd class="font-semibold text-gray-700"><?php echo e(number_format($document->view_count)); ?></dd>
                    </div>
                </dl>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Development\Webhoclieu-laravel\resources\views/documents/download-wait.blade.php ENDPATH**/ ?>
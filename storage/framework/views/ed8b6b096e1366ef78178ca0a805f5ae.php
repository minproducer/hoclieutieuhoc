...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
             <?php $__env->slot('heading', null, []); ?> Trạng thái kết nối Google Drive <?php $__env->endSlot(); ?>

            <div class="flex items-center justify-between">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->isGoogleDriveConnected()): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['wire:click' => 'disconnectGoogleDrive','color' => 'danger','size' => 'sm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'disconnectGoogleDrive','color' => 'danger','size' => 'sm']); ?>
                        Ngắt kết nối
...
<?php endif; ?>
                <?php else: ?>
                    ...
                    <a href="<?php echo e(route('admin.drive.auth')); ?>"
...
<?php endif; ?>
<?php /**PATH D:\Development\Webhoclieu-laravel\resources\views/filament/pages/settings-page.blade.php ENDPATH**/ ?>
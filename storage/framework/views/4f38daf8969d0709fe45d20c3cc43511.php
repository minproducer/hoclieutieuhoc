...
<?php $__env->startSection('title', 'HocLieuTieuHoc - Thư viện tài liệu giáo dục Tiểu học miễn phí'); ?>
<?php $__env->startSection('description', 'HocLieuTieuHoc - Kho tài liệu giáo dục miễn phí cho học sinh Tiểu học. PDF, DOCX, PPTX — bài ôn tập, đề thi, rèn kĩ năng từ lớp Tiền tiểu học đến lớp 5.'); ?>
...
<section class="relative overflow-hidden"
        ...
        <div style="text-align:left;">
            ...
            <div style="display:flex;align-items:center;flex-wrap:wrap;gap:20px;margin-top:2rem;">
                <div style="display:flex;align-items:center;gap:8px;font-size:14px;font-weight:700;color:#1a3200;">
                    ...
                    <span><?php echo e($heroStatDocs); ?></span>
                </div>
                <div style="width:1px;height:16px;background:rgba(26,50,0,.3);"></div>
                <div style="display:flex;align-items:center;gap:8px;font-size:14px;font-weight:700;color:#1a3200;">
                    <i class="fa-solid fa-download"></i>
                    <span><?php echo e($heroStatDownloads); ?></span>
                </div>
                <div style="width:1px;height:16px;background:rgba(26,50,0,.3);"></div>
                <div style="display:flex;align-items:center;gap:8px;font-size:14px;font-weight:700;color:#1a3200;">
                    <i class="fa-solid fa-star"></i>
                    <span><?php echo e($heroStatFree); ?></span>
                </div>
            </div>
        </div>
            ...
            <div class="doc-fa" style="position:absolute;top:0;right:10px;">
                <div class="hdoc">
                    <div style="display:flex;align-items:center;gap:11px;margin-bottom:12px;">
                        ...
                        <div>
                            <div style="font-size:10px;font-weight:800;color:#ef4444;text-transform:uppercase;letter-spacing:.08em;margin-bottom:3px;"><?php echo e($heroCard1Subject); ?></div>
                            <div style="font-size:13px;font-weight:700;color:#111827;line-height:1.35;"><?php echo nl2br(e($heroCard1Title)); ?></div>
                        </div>
                    </div>
                    ...
                    <div style="display:flex;justify-content:space-between;font-size:11px;color:#9ca3af;">
                        <span><?php echo e($heroCard1Views); ?></span>
            ...
            <div class="doc-fb" style="position:absolute;top:145px;right:40px;">
                <div class="hdoc">
                    <div style="display:flex;align-items:center;gap:11px;margin-bottom:12px;">
                        ...
                        <div>
                            <div style="font-size:10px;font-weight:800;color:#f97316;text-transform:uppercase;letter-spacing:.08em;margin-bottom:3px;"><?php echo e($heroCard2Subject); ?></div>
                            <div style="font-size:13px;font-weight:700;color:#111827;line-height:1.35;"><?php echo nl2br(e($heroCard2Title)); ?></div>
                        </div>
                    </div>
                    <div style="height:3px;background:#f3f4f6;border-radius:99px;overflow:hidden;margin-bottom:9px;">
                    ...
                    <div style="display:flex;justify-content:space-between;font-size:11px;color:#9ca3af;">
                        <span><?php echo e($heroCard2Views); ?></span>
                        <span style="background:#dcfce7;color:#16a34a;font-weight:700;padding:2px 8px;border-radius:99px;">Miễn phí</span>
                    </div>
                </div>
            </div>
            ...
            <div class="doc-fc" style="position:absolute;top:290px;right:15px;">
                <div class="hdoc">
                    <div style="display:flex;align-items:center;gap:11px;margin-bottom:12px;">
                        ...
                        <div>
                            <div style="font-size:10px;font-weight:800;color:#3b82f6;text-transform:uppercase;letter-spacing:.08em;margin-bottom:3px;"><?php echo e($heroCard3Subject); ?></div>
                            <div style="font-size:13px;font-weight:700;color:#111827;line-height:1.35;"><?php echo nl2br(e($heroCard3Title)); ?></div>
                        </div>
                    </div>
                    <div style="height:3px;background:#f3f4f6;border-radius:99px;overflow:hidden;margin-bottom:9px;">
                    ...
                    <div style="display:flex;justify-content:space-between;font-size:11px;color:#9ca3af;">
                        <span><?php echo e($heroCard3Views); ?></span>
                        <span style="background:#dcfce7;color:#16a34a;font-weight:700;padding:2px 8px;border-radius:99px;">Miễn phí</span>
                    </div>
                </div>
            </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($heroMascot): ?>
    <div class="hero-mascot" style="position:absolute;bottom:0;left:50%;transform:translateX(-50%);z-index:10;pointer-events:none;">
        <img src="<?php echo e($heroMascot); ?>" alt=""
             style="width:<?php echo e($heroMascotSize); ?>px;height:auto;mix-blend-mode:multiply;">
    </div>
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-0 divide-x divide-gray-100">
            <div style="text-align:center;padding:20px 16px;">
                ...
                <div style="font-size:1.65rem;font-weight:900;color:#1f2937;line-height:1;"><?php echo e(number_format($dTotal)); ?>+</div>
            ...
            <div style="text-align:center;padding:20px 16px;">
                ...
                <div style="font-size:1.65rem;font-weight:900;color:#1f2937;line-height:1;"><?php echo e(number_format($dViews)); ?>+</div>
            ...
            <div style="text-align:center;padding:20px 16px;">
                ...
                <div style="font-size:1.65rem;font-weight:900;color:#1f2937;line-height:1;"><?php echo e(number_format($dDL)); ?>+</div>
            ...
            <div style="text-align:center;padding:20px 16px;">
                ...
                <div style="font-size:1.65rem;font-weight:900;color:#1f2937;line-height:1;"><?php echo e($dCats); ?></div>
...
<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php $ci = $i % 8; ?>
        <a href="<?php echo e(route('category.show', $category->slug)); ?>"
           ...
           style="text-decoration:none;">
            <div class="grade-icon w-14 h-14 rounded-2xl flex items-center justify-center"
                 style="background:<?php echo e($gradeColors[$ci]); ?>;">
                <i class="fa-solid <?php echo e($category->icon ?? 'fa-book-open'); ?> text-xl" style="color:<?php echo e($gradeIconColors[$ci]); ?>;"></i>
            </div>
            <span class="font-bold text-sm text-gray-700 group-hover:text-primary-600 transition-colors leading-tight"><?php echo e($category->name); ?></span>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($category->doc_count ?? 0) > 0): ?>
            <span class="text-[11px] text-gray-400"><?php echo e($category->doc_count); ?> tài liệu</span>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </a>
...
<section style="background:white;padding:2.5rem 0 3rem;border-top:1px solid #f3ede4;border-bottom:1px solid #f3ede4;">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:10px;">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$name, $icon, $iconColor, $q]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('search', ['q' => $q])); ?>" class="subj-pill">
                <i class="fa-solid <?php echo e($icon); ?>" style="color:<?php echo e($iconColor); ?>;"></i>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($featuredDocs->isNotEmpty()): ?>
<section style="background:#faf5ee;padding:3rem 0;">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between mb-7">
            ...
            <a href="<?php echo e(route('search')); ?>" class="text-sm font-semibold text-primary-500 hover:text-primary-600 flex items-center gap-1.5">
                Xem tất cả <i class="fa-solid fa-arrow-right text-xs"></i>
            </a>
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $featuredDocs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recentDocs->isNotEmpty()): ?>
<section style="padding:3rem 0;">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between mb-7">
            ...
            <a href="<?php echo e(route('search', ['sort' => 'newest'])); ?>" class="text-sm font-semibold text-primary-500 hover:text-primary-600 flex items-center gap-1.5">
                Xem tất cả <i class="fa-solid fa-arrow-right text-xs"></i>
            </a>
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $recentDocs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if (isset($component)) { $__componentOriginal1869097a6231e2ce70c4554b764f4faa = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal1869097a6231e2ce70c4554b764f4faa = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.document-card','data' => ['document' => $doc]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('document-card'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Development\Webhoclieu-laravel\resources\views/home.blade.php ENDPATH**/ ?>